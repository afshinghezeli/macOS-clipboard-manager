...
- Group related tests in a `@Suite` struct. Name tests after behavior: `@Test func reCopyingMovesItemToTop()`.
- Parameterize with `@Test(arguments:)` instead of copy-pasted cases.
